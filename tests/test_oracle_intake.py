...
from oracle_submission import read_pr_submission, publish_submission, strict_json
...
@pytest.mark.parametrize('kind',['malformed','duplicate_key','extra_code','symlink','test_path',
